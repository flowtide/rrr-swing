...
| 거래일 | 일자 | 정규장 표본수 | 전 축 커버리지 | H1 (큰손 흡수) | H2 (외인반대) | H3 (기관동행) | H4 (숨은매집) | H5 (이례도) | 주요 조치 및 방법론 변경 |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|---|
...
| **2일누적** | **전세션** | **4,950봉**<br>(정규 2,728) | — | **179건 (65%)**<br>[프리 85% / 정규 58% / 야간 51%] | **89건 (75%)**<br>[NXT 83% / KRX 44%] | **83건 (66%)**<br>[KRX 71% / NXT 59%] | **57건 (61%)**<br>[KRX 95% / NXT 62%] | **419건 (50%)**<br>[대형 48% / 중형 65%] | 프리마켓 큰손 흡수 85% 폭등 선행(+89bp), 중형주 되돌림 성립(+37bp), 야간 매집 반등 |
